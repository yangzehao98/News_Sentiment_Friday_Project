...
test_sentence_sentiment_mcdonald = sentiment_processor.process(sentence_tokenized = test_sentence_tokenized, sentiment_model = 'mcdonald')
...
news_sentiment_processor.process(test_news)
